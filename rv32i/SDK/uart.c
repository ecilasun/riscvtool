...
volatile uint32_t *IO_UARTRX     = (volatile uint32_t* ) 0x80001000;
volatile uint32_t *IO_UARTTX     = (volatile uint32_t* ) 0x80001004;
volatile uint32_t *IO_UARTStatus = (volatile uint32_t* ) 0x80001008;
