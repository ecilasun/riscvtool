...
riscv64-unknown-elf-g++ -o ROM_nekoichi.elf test/ROM_nekoichi.cpp test/nekoichi.cpp -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections,--strip-debug --specs=nano.specs -fPIC -lgcc -nostartfiles -Wl,-Ttest/ROM_nekoichi.lds
riscv64-unknown-elf-g++ -o ROM_nekoni.elf test/ROM_nekoni.cpp test/nekoichi.cpp -std=c++11 -Wall -Ofast -march=rv32e -mabi=ilp32e -ffunction-sections -fdata-sections -Wl,-gc-sections,--strip-debug --specs=nano.specs -fPIC -lgcc -nostartfiles -Wl,-Ttest/ROM_nekoni.lds
...
#riscv64-unknown-elf-g++ -o ROM_experimental.elf test/ROM_experimental.cpp test/debugger.cpp test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c test/console.cpp -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -nostartfiles -Wl,-Ttest/ROM_experimental.lds
# NOTE: this one will generate line debug/line number information (-g)
riscv64-unknown-elf-g++ -o ROM_experimental.elf test/ROM_experimental.cpp test/debugger.cpp test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c test/console.cpp -mcmodel=medany -std=c++11 -Wall -Ofast -g -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections,--strip-debug --specs=nano.specs -fPIC -lgcc -lm

# Examples for nekoichi
# Each one shows or test a certain functionality and serve as how-to examples
riscv64-unknown-elf-g++ -o rainsynth.elf test/rainsynth.cpp test/nekoichi.cpp -mcmodel=medany -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -lm
riscv64-unknown-elf-g++ -o modplayer.elf test/modplayer.cpp test/micromod.c test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c -mcmodel=medany -std=c++11 -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -lm
riscv64-unknown-elf-g++ -o ddrtest.elf test/ddrtest.cpp test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c -mcmodel=medany -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -lm
riscv64-unknown-elf-g++ -o gpupipetest.elf test/gpupipetest.cpp test/nekoichi.cpp test/console.cpp -mcmodel=medany -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -lm
riscv64-unknown-elf-g++ -o miniterm.elf test/miniterm.cpp test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c test/console.cpp -mcmodel=medany -std=c++11 -Wall -Ofast -march=rv32imf -mabi=ilp32f -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgcc -lm
riscv64-unknown-elf-g++ -o mandelbrot.elf test/mandelbrot.cpp test/nekoichi.cpp test/sdcard.cpp fat32/ff.c fat32/diskio.c -std=c++11 -Wall -ffast-math -Ofast -mcmodel=medany -march=rv32imf -mabi=ilp32f  -ffunction-sections -fdata-sections -Wl,-gc-sections -fPIC -lgloss -lm
