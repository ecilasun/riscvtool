...
riscv64-unknown-elf-g++.exe -o miniterm.elf test/miniterm.cpp -Ofast -march=rv32imc -mabi=ilp32 -ffreestanding -fno-common -static -mcmodel=medany -fvisibility=hidden -fPIC -ffunction-sections -fdata-sections -Wl,-e_start -Wl,-melf32lriscv -Wl,-gc-sections -Wl,--strip-debug -lc -lgcc -Wl,-Ttest/EMBEDDED.lds
riscv64-unknown-elf-g++.exe -o instructiontest.elf test/instructiontest.cpp -Ofast -fno-use-cxa-atexit -fno-exceptions -fno-rtti -march=rv32imc -mabi=ilp32 -ffreestanding -fno-common -static -fvisibility=hidden -fPIC -ffunction-sections -fdata-sections -Wl,-gc-sections -Wl,--strip-debug -lc -lgcc -Wl,-Ttest/EMBEDDED.lds
