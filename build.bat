...
riscv64-unknown-elf-gcc.exe -o miniterm.elf test/miniterm.cpp test/umm_malloc.c -Ofast -mexplicit-relocs -march=rv32imc -mabi=ilp32 -static -mcmodel=medany -fvisibility=hidden -fPIC -ffunction-sections -fdata-sections -Wl,-e_start -Wl,-melf32lriscv -Wl,-gc-sections -lc -lgcc -Wl,-Ttest/APP.lds
...
riscv64-unknown-elf-gcc.exe -o instructiontest.elf test/instructiontest.cpp test/umm_malloc.c -Ofast -mexplicit-relocs -march=rv32imc -mabi=ilp32 -static -mcmodel=medany -fvisibility=hidden -fPIC -ffunction-sections -fdata-sections -Wl,-e_start -Wl,-melf32lriscv -Wl,-gc-sections -lc -lgcc -Wl,-Ttest/APP.lds
