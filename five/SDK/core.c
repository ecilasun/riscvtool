...
//#undef errno
//int nerrno;
static uint8_t *heap_start  = (uint8_t*)0x00008000; // Program/static data can use up to 64MBytes, rest is for dynamic memory
static uint8_t *heap_end    = (uint8_t*)0x0000FFFF; // ~448MBytes of heap, minus 128KBytes at the end reserved for OS buffers and HART stacks
