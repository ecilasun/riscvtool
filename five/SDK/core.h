...
#define ONE_SECOND_IN_TICKS				50000000
#define HUNDRED_MILLISECONDS_IN_TICKS	5000000
#define TEN_MILLISECONDS_IN_TICKS		500000
#define ONE_MILLISECOND_IN_TICKS		50000
#define ONE_MICROSECOND_IN_TICKS		50
