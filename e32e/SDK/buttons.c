...
volatile uint32_t *BUTTONCHANGE = (volatile uint32_t* )0x80001050;
volatile uint32_t *BUTTONCHANGEAVAIL = (volatile uint32_t* )0x80001054;
volatile uint32_t *BUTTONIMMEDIATESTATE = (volatile uint32_t* )0x80001058;
