...
volatile uint32_t *m_readOffset  = (volatile uint32_t*)0x80000600; // End of ringbuffer, which starts at 0x80000200 (+0x400, i.e. 1K away)
volatile uint32_t *m_writeOffset = (volatile uint32_t*)0x80000604;
