...
void HandleDemoCommands(char checkchar)
{
   ...
   *IO_UARTRXTX = checkchar;
   if (checkchar == 13)
      *IO_UARTRXTX = 10; // Echo extra linefeed
}
...
void external_interrupt(uint32_t deviceID)
{
   ...
   if (deviceID&0x0002) // SWITCHES
   {
      ...
      {
         case 0x10: printf(hardwareswitchstates&0x10 ? "GDBServer\r\n" : "Terminal\r\n"); break;
         case 0x20: printf(hardwareswitchstates&0x20 ? "S1HIGH\r\n" : "S1LOW\r\n"); break;
         case 0x40: printf(hardwareswitchstates&0x40 ? "S2HIGH\r\n" : "S2LOW\r\n"); break;
         case 0x80: printf(hardwareswitchstates&0x80 ? "S3HIGH\r\n" : "S3LOW\r\n"); break;
         case 0x01: printf(hardwareswitchstates&0x01 ? "...\r\n" : "Toggle OSMain\r\n"); osbutton = 1; break;
         case 0x02: printf(hardwareswitchstates&0x02 ? "B1DOWN\r\n" : "B1UP\r\n"); break;
         case 0x04: printf(hardwareswitchstates&0x04 ? "B2DOWN\r\n" : "B2UP\r\n"); break;
         case 0x08: printf(hardwareswitchstates&0x08 ? "B3DOWN\r\n" : "B3UP\r\n"); break;
         default: break;
      };
