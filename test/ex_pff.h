...
int pf_open (const char* path);							/* Open a file */
FRESULT pf_read (int handle, void* buff, UINT btr, UINT* br);			/* Read data from the open file */
FRESULT pf_write (int handle, const void* buff, UINT btw, UINT* bw);	/* Write data to the open file */
FRESULT pf_lseek (int handle, DWORD ofs);								/* Move file pointer of the open file */
